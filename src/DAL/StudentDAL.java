...
public class StudentDAL {
  ...
  // try {
  // // query
  // String sql = "insert into product(PRODUCT_CODE, PRODUCT_NAME, PRODUCER_NAME,
  // SUPPLIER_NAME, AMOUNT, IMPORT_PRICE, PRICE,IMAGE) values (?, ?, ?, ?, ?, ?,
  // ?,?)";
  ...
  // try {
  // // query
  // String sql = "update product set PRODUCT_NAME=?, PRODUCER_NAME=?,
  // SUPPLIER_NAME=?, AMOUNT=?, IMPORT_PRICE=?, PRICE=? , IMAGE = ? where
  // PRODUCT_CODE = ?";
  // PreparedStatement statement = dc.connection.prepareCall(sql);
