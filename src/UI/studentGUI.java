...
public class studentGUI extends JFrame {
  ...
  // cbProducer.setSelectedItem(String.valueOf(model.getValueAt(selectedIndex,
  // 3)));
  // cbSupplier.setSelectedItem(String.valueOf(model.getValueAt(selectedIndex,
  // 4)));
  ...
  // && !tfAmount.getText().trim().equals("") &&
  // !tfImportPrice.getText().trim().equals("")
  // && !tfPrice.getText().trim().equals("") &&
  // !tfImage.getText().trim().equals("")) {
  // try {
  ...
  // Product p = new Product(code, name, producer, supplier, amount, importPrice,
  // price, image);
  ...
  // JOptionPane.showMessageDialog(null, "Giá bán hoặc giá nhập hoặc số lượng phải
  // là số");
  // }
  // } else {
  // JOptionPane.showMessageDialog(null, "Vui lòng nhập đầy đủ thông tin của sản
  // phẩm");
  // }
  // }
  ...
  // model.getRowCount() + 1, p.getProductCode(), p.getProductName(),
  // p.getProducerName(), p.getSupplierName(),
  // p.getAmount(), p.getImportPrice(), p.getPrice()
  // });
  // i++;
  // }
  // }
  ...
  // } else {
  // JOptionPane.showMessageDialog(null, "Vui lòng nhập tên của sản phẩm để tìm
  // kiếm");
  // }
  // }
  ...
  // if (index >= 0 && !tfCode.getText().equals("") &&
  // !tfProductName.getText().equals("")
  // && !tfImportPrice.getText().equals("") && !tfPrice.getText().equals("") &&
  ...
  // int option = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa sản phẩm
  // này không?", "Question",
  // JOptionPane.YES_NO_OPTION);

  // if (option == JOptionPane.YES_OPTION) {
  // int sure = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa sản
  // phẩm này không?", "Question",
  // JOptionPane.YES_NO_OPTION);
