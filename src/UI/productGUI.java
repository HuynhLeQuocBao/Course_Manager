...
public class productGUI extends JFrame {
	...
	private void btnAddActionPerformed(ActionEvent e) {
		if (!tfCode.getText().trim().equals("") && !tfProductName.getText().trim().equals("")
				&& !tfAmount.getText().trim().equals("") && !tfImportPrice.getText().trim().equals("")
				&& !tfPrice.getText().trim().equals("") && !tfImage.getText().trim().equals("")) {
			try {
			...
			if (productList.size() == 0) {
				...
				while (i < productList.size()) {
					...
					model.addRow(new Object[] {
							model.getRowCount() + 1, p.getProductCode(), p.getProductName(), p.getProducerName(), p.getSupplierName(),
	...
	private void btnEditActionPerformed(ActionEvent e) {
		try {
			...
			if (index >= 0 && !tfCode.getText().equals("") && !tfProductName.getText().equals("")
					&& !tfImportPrice.getText().equals("") && !tfPrice.getText().equals("") && !tfAmount.getText().equals("")
	...
	private void btnRemoveActionPerformed(ActionEvent e) {
		...
		if (selectedIndex >= 0 && !tfCode.getText().equals("")) {
			...
			int option = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa sản phẩm này không?", "Question",
					JOptionPane.YES_NO_OPTION);

			if (option == JOptionPane.YES_OPTION) {
				int sure = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa sản phẩm này không?", "Question",
						JOptionPane.YES_NO_OPTION);
